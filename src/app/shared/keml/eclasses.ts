export enum EClasses {
  Conversation= 'http://www.unikoblenz.de/keml#//Conversation',
  Author = 'http://www.unikoblenz.de/keml#//Author',
  ConversationPartner = 'http://www.unikoblenz.de/keml#//ConversationPartner',
